...
export const SUPPORTED_CHAINS: ChainInfo[] = [
  { id: 40, name: 'Telos', icon: '/telos-bridge-lifi/chains/telos.png', nativeCurrency: 'TLOS' },
  ...
  { id: 100, name: 'Gnosis', icon: '/telos-bridge-lifi/chains/gnosis.png', nativeCurrency: 'XDAI' },
